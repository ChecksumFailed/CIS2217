...
public class Facebook implements Serializable {
	...
	GenericStack<FacebookUndo> undoList = new GenericStack<>();
	...
	class FacebookUndo {
		Integer undoAction; //Undo action to perform
		...
		FacebookUndo(Integer undoAction,Object sourceObj, Object undoObj) {
